...
public class RecordAction {
	...
	public Object[][] CreateRecTable1(String[] columnNames,JTextField textFieldaim) throws Exception{
		RecDao recDao = new RecDao();
		List list =recDao.recquery(textFieldaim.getText());
	...
	public Object[][] CreateRecTable2(String[] columnNames,JTextField textFieldaim) throws Exception{
		RecDao recDao = new RecDao();
		java.sql.Date aimDate = java.sql.Date.valueOf(textFieldaim.getText());
		List list =recDao.recquery2(aimDate);
		Object[][] results = new Object[list.size()][columnNames.length];
